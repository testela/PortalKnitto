...
WebUI.click(findTestObject('Page_Packing Desktop Web/Card Site'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('Page_Packing Desktop Web/div_C2309000082'), '888')

WebUI.sendKeys(findTestObject('Page_Packing Desktop Web/div_C2309000082'), Keys.chord(Keys.ENTER))
